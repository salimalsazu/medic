...
const getAllMyReviews = async ( profileId:string): Promise<ReviewAndRatings[]> => {
  //
...
const SingleRatingAndReviewDelete = async (reviewId: string): Promise<ReviewAndRatings | null> => {
