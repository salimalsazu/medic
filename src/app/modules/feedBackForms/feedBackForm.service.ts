...
import { FeedBackSearchableFields, feedBackRelationalFields, feedBackRelationalFieldsMapper } from './feedBackForm.constant';
...
const SingleFeedbackDelete = async (feedbackId: string): Promise<FeedBackForm | null> => {
